...
<head>
	...
	function layCongViec(cv){
		$.post('quanli-sv-query.php', {'cv':cv}, function(data) {$("#form1").html(data);});
	}
    </script>
    <style>
	body{
...
<div class="TR1" id="TR1">
    <div id="div-1">
        ...
        <select name="selcectCV" onChange="layCongViec(this.value)">
            <option>------------</option>
            <option>Thêm Danh Sách Sinh Viên theo Lớp</option>
            <option>Thêm Sinh Viên</option>
            <option>Chỉnh Sửa Thông Tin Sinh Viên</option>
        </select>
