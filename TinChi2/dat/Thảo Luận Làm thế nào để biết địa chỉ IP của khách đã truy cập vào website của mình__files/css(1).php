...
.forum_info_subblock h4,.forum_info_subblock h5,.forum_info_subblock h6
{
	font-weight: bold;
	margin-bottom: 5px;
	display: inline-block;
...
.similar_threads .titleblock {float:left;max-width:70%;}
...
#pollinfo .button:hover
{
	background-color: #C02C24;
}
#pollinfo .blockfoot .group a.textcontrol
{
	background-image: none !important;
...
#pollinfo .blockfoot .group a.textcontrol:hover
{
	background-color: #0681E4;
}
