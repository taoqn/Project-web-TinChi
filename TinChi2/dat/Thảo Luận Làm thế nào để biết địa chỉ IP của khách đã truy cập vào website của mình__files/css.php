...
.button {
	padding: 2.5px 5px;
	font:   lighter 13px Tahoma, Calibri, Verdana, Geneva, sans-serif;
...
.blockhead {
	...
	color:#6F6F6F;
	background:#E0E0E0 none repeat-x  ;
	_background-image: none;
	padding:7px 10px 7px 10px;
	border:0 solid #5a7f97;
...
.blockhead a { color:#6F6F6F; }
.blockhead a:hover { color:#6D6D6D; }
...
.link_box > .inner > .link_list
{
	margin: 0 20px 20px 20px;
    padding: 0;
    display: block;
}
.link_box > .inner > .link_list > .link_bit
{
	display: inline-block;
	width: 188px; /*20%*/
	overflow: hidden;
...
.link_box > .inner > .link_list > .link_bit a
{
	color: #1a1a1a;
	font-size: 12px;
	font-family: Arial, Tahoma, sans-serif;
}
.link_box > .inner > .link_list > .link_bit a:hover
{
	color: #0642FF;
}
