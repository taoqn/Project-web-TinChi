...
(function(){
	...
	*/
	function parseCSS(css){
		var elArr = ['stdbannerdiv','stdbannerflash','banneriframe','banneriframediv','bannerdivparent','bannerdiv','bannerflash','paneldiv','panelflash','blankimg','defaultimg'];
		var cssArr = [];	
		var cssH = true;
		var cssB = false;
		var curH = "";
