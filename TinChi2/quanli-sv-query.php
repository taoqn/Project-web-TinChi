...
?>
    ...
    <script type="text/javascript">
        ...
        function XoaSV(so){
            ...
            xoaS++;
            $("#soLanDaNhap").html("<b>Bạn đã thêm "+demSV+" Sinh viên và xóa "+xoaS+" Sinh viên !</b>");
        }
        var demSV=0,xoaS=0;
...
<?php
        ...
        $maSV=Data::capNhatMASV($_POST['tenLopSH'],$maSV);
        
        $bangSV="CREATE TABLE IF NOT EXISTS `".$maSV."` (
  ...
  PRIMARY KEY (`sott`)
        ...
        $ht=Data::TruyVanDiem($bangSV);//Tạo Bảng
        ...
        while($row2=mysqli_fetch_array($kqua2))
        {
            ...
            if($dk==1)
            {
                $sql4="INSERT INTO `quanli_diem`.`".$maSV."` 
                    VALUES (NULL,
                     '".$row2['tenMon']."',
                      '".$row2['maMon']."',
                       NULL,
                        '".$row2['soTC']."',
                         '".$row2['HK']."',
                          NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '".$row2['rangBuoc']."', NULL);";
    ...
    if(isset($_POST['soThuTu']))
    {
        ...
        {$tenLopHP=$row['lop'];$maSV=$row['masv'];}
